                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($cat as $data) : ?>
                                        <tr>
                                            <td id="tabNama"><?= $data['nama_category'] ?></td>
                                            <td>
                                                <a href="<?= base_url('edit-subcategory/') . $data['id_category'] ?>" class="text-primary" title="Ubah"><i class="fas fa-pen"></i></a>
                                                <a href="<?= base_url('delete-subcategory/') . $data['id_category'] ?>" class="text-danger ml-3" title="Hapus"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambah" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('add-subcategory') ?>" method="POST">
